	...
	(function ($, win, undef) {
		...
		Validform.util = {
			...
			showmsg: function (msg, type, o, triggered) {
				...
				if (type == 1 && triggered != "bycheck" && o.type != 2 || triggered == "byajax" && type != 4) {
					...
					$('<div class="shadow-box" style="width: 100%; height: 100%; position: fixed; z-index: 1987; top: 0px; left: 0px; overflow: hidden;"><div style="height: 100%; opacity: 0.7; background: rgb(0, 0, 0);"></div></div>').appendTo('body');
					msgobj.show();
		...
		function creatMsgbox() {
			...
			$(window).bind("scroll resize", function () {
				!msghidden && setCenter(msgobj, 100);
			});
		};

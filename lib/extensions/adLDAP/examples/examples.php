...
try {
	$options = array(
		//"account_suffix" => "@noahwm.local",
		//"base_dn" => "DC=mydomain,DC=local",
		"domain_controllers" => array("KS-DC-02.e-neway.com.local"),
		//"domain_controllers" => array("10.21.100.44"),
		"admin_username" => "lwj5577",
		"admin_password" => "g6qq.com2",
		//"use_ssl" => true,
	);
...
if (1) {
	$result = $adldap->authenticate("lwj5577", "g6qq.com2");
	var_dump($result);
}

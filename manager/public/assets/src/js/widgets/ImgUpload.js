...
define([
...
], function ($, Handlebars, Qiniu, tpl, itemTpl, pdfItemTpl, loadingTpl, wordItemTpl) {
    ...
    ImgUpload.prototype = {
        init: function(placeholder, options) {
            ...
            this.wordItemTpl = Handlebars.compile(wordItemTpl);
            ...
            (new QiniuJsSDK()).uploader({
                ...
                filters: {
                    mime_types : [
                        { title : "Image files", extensions : this.options.uploadType ? this.options.uploadType : "jpg,gif,png,bmp,jpeg" }
                    ]
                },
                init: {
